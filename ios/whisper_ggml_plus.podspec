...
Whisper.cpp Flutter plugin with Large-v3-Turbo (128-mel) support.
  ...
  s.pod_target_xcconfig = {
    ...
    'OTHER_CFLAGS' => '-DWHISPER_COREML -DWHISPER_COREML_ALLOW_LOW_LATENCY -DGGML_USE_METAL=1 -DGGML_USE_CPU -DGGML_CPU_GENERIC',
    'OTHER_CPLUSPLUSFLAGS' => '-DWHISPER_COREML -DWHISPER_COREML_ALLOW_LOW_LATENCY -DGGML_USE_METAL=1 -DGGML_USE_CPU -DGGML_CPU_GENERIC',
